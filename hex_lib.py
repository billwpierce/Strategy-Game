...
# The second section is helper functions I have written, based on the tutorial
# The third section is the auto-generated library from redblobgames
...
def test_offset_from_cube():
    equal_offsetcoord("offset_from_cube even-q", OffsetCoord(1,
                                                             3), qoffset_from_cube(EVEN, Hex(1, 2, -3)))
    equal_offsetcoord("offset_from_cube odd-q", OffsetCoord(1,
                                                            2), qoffset_from_cube(ODD, Hex(1, 2, -3)))
